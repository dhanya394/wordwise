...
list1 = ["bird", "five", "four", "go", "happy", "house", "left", "marvin", "off", "on", "one", "right", "sheila", "six", "stop", "three", "tree", "two", "wow", "zero"]
phon = [['Y', 'EH', 'S'], ['N', 'OW'], ['AH', 'P'], ['D', 'AW', 'N'], ['B', 'EH', 'D'], ['K', 'AE', 'T'], ['D', 'AO', 'G'], ['S', 'EH', 'V', 'AH', 'N'], ['EY', 'T'], ['N', 'AY', 'N']]
phone2 = [['B', 'ER', 'D'], ['F', 'AY', 'V'], ['F', 'AO', 'R'], ['G', 'OW'], ['HH', 'AE', 'P', 'IY'], ['HH', 'AW', 'S'], ['L', 'EH', 'F', 'T'], ['M', 'AA', 'R', 'V', 'IH', 'N'],
          ['AO', 'F'], ['AA', 'N'], ['W', 'AH', 'N'], ['R', 'AY', 'T'], ['SH', 'IY', 'L', 'AH'], ['S', 'IH', 'K', 'S'], ['S', 'T', 'AA', 'P'], ['TH', 'R', 'IY'],
          ['T', 'R', 'IY'], ['T', 'UW'], ['W', 'AW'], ['Z', 'IY', 'R', 'OW']]
wrong_phonemes = []
picpath = ["E:\\Major Project stuff\\Major Project\\pictures\\yes.gif", "E:\\Major Project stuff\\Major Project\\pictures\\no.gif",
           "E:\\Major Project stuff\\Major Project\\pictures\\up.gif", "E:\\Major Project stuff\\Major Project\\pictures\\down.gif",
           "E:\\Major Project stuff\\Major Project\\pictures\\bed.gif", "E:\\Major Project stuff\\Major Project\\pictures\\cat.gif",
           "E:\\Major Project stuff\\Major Project\\pictures\\dog.gif", "E:\\Major Project stuff\\Major Project\\pictures\\seven.gif",
           "E:\\Major Project stuff\\Major Project\\pictures\\eight.gif", "E:\\Major Project stuff\\Major Project\\pictures\\nine.gif"]
...
def click1():
    ...
    def click3():
        ...
        Label(fr3, text="Choose Word", bg='black', fg='white', font='none 12 bold').grid(row=1, column=0, padx=10, pady=10,
                                                                                   sticky=W)
