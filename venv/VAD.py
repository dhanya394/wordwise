...
class VoiceActivityDetector():
    ...
    def __init__(self, wave_input_filename):
        ...
        self.sample_window = 0.5
        self.sample_overlap = 0.1  #
        self.speech_window = 0.5  # half a second
        #self.speech_energy_threshold = 0.6  # 60% of energy in voice band
        #self.speech_start_band = 300
        #self.speech_end_band = 3000
        self.speech_energy_threshold = 0.4  # 60% of energy in voice band
        self.speech_start_band = 50
        self.speech_end_band = 1000
    ...
    def plot_detected_speech_regions(self):
        ...
        # plt.xlim(data_speech[0].key() , )
        # plt.ylim(0,1)
        #plt.plot(data)
        #plt.show()
        # print("This is the data containing the speech windows : ",data_speech)
        return data_speech,data
...
if __name__ == "__main__":
    ...
    #inputfile1 = r"E:\AUGMENTATIVE AND ALTERNATIVE COMMUNICATION PROJECT\dataset dysarthria\FC\FC01\Session1\wav_headMic\0002.wav"
    #inputfile2 = r"E:\AUGMENTATIVE AND ALTERNATIVE COMMUNICATION PROJECT\dataset dysarthria\F\F01\Session1\wav_headMic\0002.wav"
    inputfile1 = r"E:\Major Project stuff\Major Project\Datasets\Speech Commands Dataset\yes\0ac15fe9_nohash_0.wav"
    inputfile2 = r'E:\Major Project stuff\Major Project\Datasets\Speech Commands Dataset\seven\0b40aa8e_nohash_0.wav'
    outputfile = r"C:\Users\acer\PycharmProjects\SpeechRecognition\venv\Scripts\output.json"
    v1 = VoiceActivityDetector(inputfile1)
    v2 = VoiceActivityDetector(inputfile2)
    ...
    # save_to_file(speech_labels1, outputfile)
    ...
    # save_to_file(speech_labels2, outputfile)
    plot1 = v1.plot_detected_speech_regions()
    plot2 = v2.plot_detected_speech_regions()
    # print("PLOT 1 " ,plot1)