...
word_path = {"yes": r"E:\Major Project stuff\Major Project\Datasets\Speech Commands Dataset\yes\0ac15fe9_nohash_0.wav",
             "no": r"E:\Major Project stuff\Major Project\Datasets\Speech Commands Dataset\no\0ab3b47d_nohash_0.wav",
             "up": r"E:\Major Project stuff\Major Project\Datasets\Speech Commands Dataset\up\0c2ca723_nohash_0.wav"}


con = sqlite3.Connection('wordwise_db1')
cur = con.cursor()
cur.execute(
    "create table if not exists wordwise(name varchar(20), age varchar(20), gender varchar(20), password varchar(20), username varchar(20) primary key not null)")
        ...
        for i in range(5):
            ...
            def click():
                ...
                if (word2 == word1):
                    ...
                    Label(fr3, text="Points " + str(points), bg='black', fg='blue', font='none 12 bold').grid(row=0,
                                                                                                              column=2,
                                                                                                              padx=10,
                                                                                                              pady=10)
        ...
        def click1():
            ...
            def click3():
                ...
                def detect():
                    ...
                    sl1 = "These are the speech labels of normal speech input : [ "
                    for q in range(len(speech_labels1)):
                        sl1 = sl1 + "{ 'speech_begin' : "
                        sl1 = sl1 + str(speech_labels1[q]['speech_begin'])
                        sl1 = sl1 + ", 'speech_end': "
                        sl1 = sl1 + str(speech_labels1[q]['speech_end'])
                        sl1 = sl1 + "}, "
                    sl1 =sl1 + "]"
                    #print(sl1)

                    sl2 = "These are the speech labels of the child's speech input :  ["
                    for q in range(len(speech_labels2)):
                        sl2 = sl2 + "{ 'speech_begin' : "
                        sl2 = sl2 + str(speech_labels2[q]['speech_begin'])
                        sl2 = sl2 + ", 'speech_end': "
                        sl2 = sl2 + str(speech_labels2[q]['speech_end'])
                        sl2 = sl2 + "}, "
                    sl2 = sl2 + "]"
                    #print(sl2)

                    Label(fr8, text=sl1, bg='black', fg='white', font='none 12 bold').grid(row=4, column=0,
                                                                                                     padx=10,
                                                                                                     pady=10)
                    Label(fr8, text=sl2, bg='black', fg='white', font='none 12 bold').grid(row=5, column=0,
                                                                                           padx=10,
                                                                                           pady=10)
